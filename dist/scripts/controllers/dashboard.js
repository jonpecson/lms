...
function dashboardCtrl($scope, $interval, COLORS, $firebaseArray, firebase) {

    var vm = this;
    vm.lessons = $firebaseArray(firebase.database().ref().child("lessons"));
    vm.quizzes = $firebaseArray(firebase.database().ref().child("quizzes"));
    vm.results = $firebaseArray(firebase.database().ref().child("results"));
    vm.students = $firebaseArray(firebase.database().ref().child("students"));
